...
const Home: React.FC = () => {
  ...
  const stats = [
    { label: 'Total Users', value: '10+', icon: '👤' },
    { label: 'API Endpoints', value: '3', icon: '🌐' },
    { label: 'Data Points', value: '60+', icon: '📈' },
    ...
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 rounded-lg shadow-xl p-8 text-white">
        ...
        <p className="text-lg text-primary-100 mb-6">
          A modern, responsive dashboard built with React, Redux, TypeScript, and Tailwind CSS
        </p>
        <Link
          to="/data"
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="flex flex-wrap gap-2">
          {['React', 'TypeScript', 'Redux Toolkit', 'React Router', 'Tailwind CSS', 'Axios', 'Vite'].map((tech) => (
            <span
              key={tech}
